		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VocabularyClass_prefix_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VocabularyClass_prefix_feature", "_UI_VocabularyClass_type"),
				 FramewebPackage.Literals.VOCABULARY_CLASS__PREFIX,
				 true,
				 false,
				 false,
