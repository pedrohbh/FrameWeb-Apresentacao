...
/**
 * This is the item provider adapter for a {@link frameweb.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_size_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_size_feature", "_UI_Attribute_type"),
				 FramewebPackage.Literals.ATTRIBUTE__SIZE,
				 true,
				 false,
				 false,
	...
	protected void addIsNullPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_isNull_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_isNull_feature", "_UI_Attribute_type"),
				 FramewebPackage.Literals.ATTRIBUTE__IS_NULL,
				 true,
				 false,
				 false,
	...
	protected void addIsPersistentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_isPersistent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_isPersistent_feature", "_UI_Attribute_type"),
				 FramewebPackage.Literals.ATTRIBUTE__IS_PERSISTENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addOwlEquivalentPropertyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_owlEquivalentProperty_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_owlEquivalentProperty_feature", "_UI_Attribute_type"),
				 FramewebPackage.Literals.ATTRIBUTE__OWL_EQUIVALENT_PROPERTY,
				 true,
				 false,
				 false,
