...
/**
 * This is the item provider adapter for a {@link frameweb.DomainVocabularyClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainVocabularyClassItemProvider extends ClassItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DomainVocabularyClassItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DomainVocabularyClass_Prefix_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DomainVocabularyClass_Prefix_feature", "_UI_DomainVocabularyClass_type"),
				 FramewebPackage.Literals.DOMAIN_VOCABULARY_CLASS__PREFIX,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns DomainVocabularyClass.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DomainVocabularyClass"));
	}
	...
	public String getText(Object object) {
		String label = ((DomainVocabularyClass)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DomainVocabularyClass_type") :
			getString("_UI_DomainVocabularyClass_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DomainVocabularyClass.class)) {
			case FramewebPackage.DOMAIN_VOCABULARY_CLASS__PREFIX:
