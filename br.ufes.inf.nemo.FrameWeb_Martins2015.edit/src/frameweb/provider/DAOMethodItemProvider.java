		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DAOMethod_methodType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DAOMethod_methodType_feature", "_UI_DAOMethod_type"),
				 FramewebPackage.Literals.DAO_METHOD__METHOD_TYPE,
				 true,
				 false,
				 false,
