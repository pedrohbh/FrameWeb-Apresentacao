...
/**
 * This is the item provider adapter for a {@link br.ufes.inf.nemo.frameweb.model.frameweb.DomainVocabularyAssociation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainVocabularyAssociationItemProvider extends AssociationItemProvider
{
	/**
	 ...
	 * @generated
	 */
	public DomainVocabularyAssociationItemProvider(AdapterFactory adapterFactory)
	{
	...
	/**
	 * This returns DomainVocabularyAssociation.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DomainVocabularyAssociation"));
	}
	...
	{
		String label = ((DomainVocabularyAssociation) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_DomainVocabularyAssociation_type")
				: getString("_UI_DomainVocabularyAssociation_type") + " " + label;
	}
