...
/**
 * This is the item provider adapter for a {@link br.ufes.inf.nemo.frameweb.model.frameweb.FrameworkProfile} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FrameworkProfileItemProvider extends ProfileItemProvider {
	...
	protected void addCategoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_FrameworkProfile_category_feature",
								"_UI_FrameworkProfile_type"),
						FramewebPackage.Literals.FRAMEWORK_PROFILE__CATEGORY, true, false, false,
	...
	protected void addKindPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_FrameworkProfile_kind_feature",
								"_UI_FrameworkProfile_type"),
						FramewebPackage.Literals.FRAMEWORK_PROFILE__KIND, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_FrameworkProfile_version_feature",
								"_UI_FrameworkProfile_type"),
						FramewebPackage.Literals.FRAMEWORK_PROFILE__VERSION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(UMLPackage.Literals.PACKAGE__PACKAGED_ELEMENT,
				FramewebFactory.eINSTANCE.createAuthSuccessUrl()));

		newChildDescriptors.add(createChildParameter(UMLPackage.Literals.PACKAGE__PACKAGED_ELEMENT,
				FramewebFactory.eINSTANCE.createAuthFailureUrl()));
