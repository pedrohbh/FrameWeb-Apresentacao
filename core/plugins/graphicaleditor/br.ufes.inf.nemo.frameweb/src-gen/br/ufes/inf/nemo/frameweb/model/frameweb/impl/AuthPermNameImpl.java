...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Auth Perm Name</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link br.ufes.inf.nemo.frameweb.model.frameweb.impl.AuthPermNameImpl#getGeneration <em>Generation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AuthPermNameImpl extends DomainAuthAttributeImpl implements AuthPermName {
	/**
	...
	protected EClass eStaticClass() {
		return FramewebPackage.Literals.AUTH_PERM_NAME;
	}
	...
	public void setGeneration(Generation newGeneration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.AUTH_PERM_NAME__GENERATION,
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == IdAttribute.class) {
			...
			case FramewebPackage.ID_ATTRIBUTE__GENERATION:
				return FramewebPackage.AUTH_PERM_NAME__GENERATION;
			default:
				return -1;
			}
		}
