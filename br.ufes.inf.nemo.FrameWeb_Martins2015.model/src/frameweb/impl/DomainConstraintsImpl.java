 ...
 * </p>
 * <ul>
 *   <li>{@link frameweb.impl.DomainConstraintsImpl#getCollection <em>Collection</em>}</li>
 *   <li>{@link frameweb.impl.DomainConstraintsImpl#getFetch <em>Fetch</em>}</li>
 *   <li>{@link frameweb.impl.DomainConstraintsImpl#getOrder <em>Order</em>}</li>
 *   <li>{@link frameweb.impl.DomainConstraintsImpl#getCascade <em>Cascade</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DomainConstraintsImpl extends ConstraintImpl implements DomainConstraints {
	...
	public void setCollection(Collection newCollection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.DOMAIN_CONSTRAINTS__COLLECTION, oldCollection, collection));
	}
	...
	public void setFetch(Fetch newFetch) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.DOMAIN_CONSTRAINTS__FETCH, oldFetch, fetch));
	}
	...
	public void setOrder(Order newOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.DOMAIN_CONSTRAINTS__ORDER, oldOrder, order));
	}
	...
	public void setCascade(Cascade newCascade) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.DOMAIN_CONSTRAINTS__CASCADE, oldCascade, cascade));
	}
