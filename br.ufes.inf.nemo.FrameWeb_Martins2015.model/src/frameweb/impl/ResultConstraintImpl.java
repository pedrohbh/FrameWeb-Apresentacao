 ...
 * </p>
 * <ul>
 *   <li>{@link frameweb.impl.ResultConstraintImpl#getExecute <em>Execute</em>}</li>
 *   <li>{@link frameweb.impl.ResultConstraintImpl#isAjax <em>Ajax</em>}</li>
 *   <li>{@link frameweb.impl.ResultConstraintImpl#getResult <em>Result</em>}</li>
 *   <li>{@link frameweb.impl.ResultConstraintImpl#getRender <em>Render</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResultConstraintImpl extends NavigationConstraintImpl implements ResultConstraint {
	...
	public void setExecute(String newExecute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.RESULT_CONSTRAINT__EXECUTE, oldExecute, execute));
	}
	...
	public void setAjax(boolean newAjax) {
		...
		ajax = newAjax;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.RESULT_CONSTRAINT__AJAX, oldAjax, ajax));
	}
	...
	public void setResult(String newResult) {
		...
		result = newResult;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.RESULT_CONSTRAINT__RESULT, oldResult, result));
	}
	...
	public void setRender(String newRender) {
		...
		render = newRender;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.RESULT_CONSTRAINT__RENDER, oldRender, render));
	}
