 ...
 * </p>
 * <ul>
 *   <li>{@link frameweb.impl.DAOMethodImpl#getMethodType <em>Method Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DAOMethodImpl extends OperationImpl implements DAOMethod {
		...
		if (methodType != null && methodType.eIsProxy()) {
			...
			if (methodType != oldMethodType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FramewebPackage.DAO_METHOD__METHOD_TYPE, oldMethodType, methodType));
			}
		}
		return methodType;
	}
	...
	public void setMethodType(Type newMethodType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.DAO_METHOD__METHOD_TYPE, oldMethodType, methodType));
	}
