 ...
 * </p>
 * <ul>
 *   <li>{@link frameweb.impl.VocabularyConstraintsImpl#getSubPropertyOf <em>Sub Property Of</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VocabularyConstraintsImpl extends ConstraintImpl implements VocabularyConstraints {
	...
	public void setSubPropertyOf(String newSubPropertyOf) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.VOCABULARY_CONSTRAINTS__SUB_PROPERTY_OF, oldSubPropertyOf, subPropertyOf));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case FramewebPackage.VOCABULARY_CONSTRAINTS__SUB_PROPERTY_OF:
				return SUB_PROPERTY_OF_EDEFAULT == null ? subPropertyOf != null : !SUB_PROPERTY_OF_EDEFAULT.equals(subPropertyOf);
		}
