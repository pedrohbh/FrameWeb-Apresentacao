 ...
 * </p>
 * <ul>
 *   <li>{@link frameweb.impl.AttributeImpl#getSize <em>Size</em>}</li>
 *   <li>{@link frameweb.impl.AttributeImpl#isIsNull <em>Is Null</em>}</li>
 *   <li>{@link frameweb.impl.AttributeImpl#isIsPersistent <em>Is Persistent</em>}</li>
 *   <li>{@link frameweb.impl.AttributeImpl#getOwlEquivalentProperty <em>Owl Equivalent Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AttributeImpl extends PropertyImpl implements Attribute {
	...
	public void setIsNull(boolean newIsNull) {
		...
		isNull = newIsNull;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.ATTRIBUTE__IS_NULL, oldIsNull, isNull));
	}
	...
	public void setIsPersistent(boolean newIsPersistent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.ATTRIBUTE__IS_PERSISTENT, oldIsPersistent, isPersistent));
	}
	...
	public void setOwlEquivalentProperty(String newOwlEquivalentProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.ATTRIBUTE__OWL_EQUIVALENT_PROPERTY, oldOwlEquivalentProperty, owlEquivalentProperty));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case FramewebPackage.ATTRIBUTE__OWL_EQUIVALENT_PROPERTY:
				return OWL_EQUIVALENT_PROPERTY_EDEFAULT == null ? owlEquivalentProperty != null : !OWL_EQUIVALENT_PROPERTY_EDEFAULT.equals(owlEquivalentProperty);
		}
