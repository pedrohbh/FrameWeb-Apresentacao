 ...
 * </p>
 * <ul>
 *   <li>{@link frameweb.impl.DomainMethodImpl#getMethodType <em>Method Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DomainMethodImpl extends OperationImpl implements DomainMethod {
		...
		if (methodType != null && methodType.eIsProxy()) {
			...
			if (methodType != oldMethodType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FramewebPackage.DOMAIN_METHOD__METHOD_TYPE, oldMethodType, methodType));
			}
		}
		return methodType;
	}
	...
	public void setMethodType(Type newMethodType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.DOMAIN_METHOD__METHOD_TYPE, oldMethodType, methodType));
	}
