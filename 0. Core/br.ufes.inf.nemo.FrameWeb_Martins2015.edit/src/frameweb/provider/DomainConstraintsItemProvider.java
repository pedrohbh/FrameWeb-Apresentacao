		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DomainConstraints_collection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DomainConstraints_collection_feature", "_UI_DomainConstraints_type"),
				 FramewebPackage.Literals.DOMAIN_CONSTRAINTS__COLLECTION,
				 true,
				 false,
				 false,
	...
	protected void addFetchPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DomainConstraints_fetch_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DomainConstraints_fetch_feature", "_UI_DomainConstraints_type"),
				 FramewebPackage.Literals.DOMAIN_CONSTRAINTS__FETCH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addOrderPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DomainConstraints_order_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DomainConstraints_order_feature", "_UI_DomainConstraints_type"),
				 FramewebPackage.Literals.DOMAIN_CONSTRAINTS__ORDER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addCascadePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DomainConstraints_cascade_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DomainConstraints_cascade_feature", "_UI_DomainConstraints_type"),
				 FramewebPackage.Literals.DOMAIN_CONSTRAINTS__CASCADE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
